...
class EditStorekeeper extends Component {
    displayName = 'Edit storekeeper'

    constructor(props) {
        super(props)
        this.apiService = ApiService()
        this.state = {
            id: null, //Chỉ dành cho 1 id duy nhất, cần sửa tim ra cach lay id tren url
            idRepository: null,
            firstName: '',
            lastName: '',
            sex: '',
                        ...
                        <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div className="product-payment-inner-st">
                                <ul id="myTabedu1" className="tab-review-design">
                                    <li className="active"><a href="#description">Chỉnh Sửa Nhân Viên Thủ Kho</a></li>
                                </ul>
...
export default connect(mapStateToProps) (EditStorekeeper);