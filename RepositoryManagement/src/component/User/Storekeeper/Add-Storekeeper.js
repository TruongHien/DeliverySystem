...
class AddStorekeeper extends Component {
  displayName = "Add new storekeeper";
            ...
            <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12">
              <div className="product-payment-inner-st">
                <ul id="myTabedu1" className="tab-review-design">
                  <li className="active">
                    <a href="#description">Thêm Mới Nhân Viên Thủ Kho</a>
                  </li>
                </ul>
                <div
                  id="myTabContent"
...
export default connect(mapStateToProps) (AddStorekeeper);
